...
nparticles = 100; maxiter = 100; tol = 1e-4; α = 0.1; β = 0.3; γ = 0.05; κ = 3; verbose = true; surrogate = false; nsim = 1; data = true; paths = true; subj = 1
...
optimize_surrogate = true; constraints = nothing; surrogate_constraints = nothing;surrogate_parameters = nothing