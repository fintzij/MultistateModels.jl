...
optimize_surrogate = true; constraints = nothing; surrogate_constraints = nothing; surrogate_parameters = nothing;  maxiter = 200; tol = 1e-3; ascent_threshold = 0.05; stopping_threshold = 0.05; ess_increase = 4/3; ess_target_initial = 100; MaxSamplingEffort = 20; npaths_additional = 10; verbose = true; return_ConvergenceRecords = true; return_ProposedPaths = false; compute_vcov = true
