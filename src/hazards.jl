...
"""
    compute_tmat_batched!(P, Q, dt_values, eigen_cache_slot, pattern_idx)
...
- `eigen_cache_slot::Ref`: Reference to cached eigendecomposition (V, Λ, V⁻¹)
                           Will be computed and cached on first call
...
"""
    invalidate_eigen_cache!(cache::TPMCache, pattern_idx::Int)
